...
| AI behavior | Primary buyer | Recommended framing |
| --- | --- | --- |
| Acts without per-action approval | Developers | "Agent" framing because they value autonomy |
| Acts without per-action approval | Enterprises | "Teammate" framing because they want visible control |
| Suggests but does not act autonomously | Any buyer | "Copilot" framing because it signals augmentation |
...
Your variable cost should usually be **20-30% of the customer's alternative cost**. Use **20%** for large or highly usage-sensitive accounts where adoption volume matters most. Use **30%** for smaller accounts or clear high-ROI workflows where you have more pricing headroom. High enough to capture value, low enough that they'll use it liberally.
...
| --- | --- | --- |
| Does the AI act autonomously without per-action approval? | Use "Agent" for developer buyers and "Teammate" for enterprise buyers | Use "Copilot" |

### Which Pricing Model Should I Use?

| Question | If yes | If no |
| --- | --- | --- |
| Can you measure customer outcomes reliably? | Use outcome-based pricing, or a hybrid with an outcome component | Check usage variability |
| Does usage vary 5x or more by customer? | Use hybrid pricing with a base fee plus usage | Use seat-based pricing |

### Is This Buyer Ready for AI Agents?

| Question | If yes | If no |
| --- | --- | --- |
| Do they have incident response processes for tool failures? | Check whether they also have on-call coverage for production systems | They are not ready yet; revisit after they build the process |
| Do they have on-call rotations for production systems? | Treat them as a qualified buyer | Help them build the operating model first |
...
**4. Pricing usage-based AI like OpenAI**
   - Your cost structure isn't theirs. Price around 20% for large or usage-sensitive accounts, and around 30% for smaller accounts with clear ROI headroom.
...
- Variable: $Y per unit (20% for large or usage-sensitive accounts; 30% for smaller, high-ROI accounts)
