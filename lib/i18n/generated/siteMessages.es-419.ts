...
export const siteMessagesEs419: SiteMessages = {
  "header": {
    ...
    "ctaLabel": "Contactar a Teambotics",
  ...
  "capabilities": {
    ...
    "items": [
      ...
      },
      {
        ...
        "body": "Diseñamos interfaces que reducen la carga cognitiva, apoyan el uso basado en roles y ayudan a los equipos a construir confianza a través de un uso práctico y repetido."
      }
    ]
  },
  "engagement": {
  ...
  "leadForm": {
    ...
    "interestAreaLabels": {
      "Workflow strategy": "Estrategia de flujo de trabajo",
      "Team enablement": "Habilitación de equipos",
      "AI chatbot or assistant": "Chatbot o asistente de IA",
      "Legal/compliance workflow": "Flujo de trabajo legal/compliance",
      "Creative or interactive platform": "Plataforma creativa o interactiva",
      "Other": "Otro"
    },
    "messageHint": "Esboza el problema, el plazo o el contexto del equipo.",
    "privacyPrefix": "Al enviar este formulario, aceptas que Teambotics puede usar tu información para responder a tu consulta. Consulta nuestra ",
    "privacyLinkLabel": "Política de Privacidad",
    "privacySuffix": ".",
    "submitLabel": "Enviar consulta",
    "submittingLabel": "Enviando...",
    "emailLabel": "¿Prefieres correo electrónico?",
    "validationErrorLabel": "Por favor, corrige los campos resaltados e intenta de nuevo.",
    "spamSuccessLabel": "Gracias. Hemos recibido tu nota.",
    "requestErrorLabel": "No se puede enviar tu mensaje en este momento.",
    "requestEmailFallbackLabel": "No se puede enviar tu mensaje en este momento. Por favor, intenta por correo electrónico.",
    "successLabel": "Gracias. Teambotics te responderá pronto."
  },
  "productPage": {
