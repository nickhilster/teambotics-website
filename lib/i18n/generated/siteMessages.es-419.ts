...
export const siteMessagesEs419: SiteMessages = {
  "header": {
  ...
  "footer": {
    ...
    "copyright": "© 2026 Teambotics. Un laboratorio independiente de IA - productos propietarios y sistemas a medida para socios seleccionados.",
  ...
  "hero": {
    ...
    "copy": "Un laboratorio independiente de IA que entrega productos propietarios y sistemas a medida para un grupo reducido de socios - operados por agentes que trabajan sin reloj.",
  ...
  "capabilities": {
    ...
    "description": "Asi abordamos arquitectura, automatizacion y diseno de interfaces en cada compromiso - con consistencia y sin atajos.",
    "items": [
      {
  ...
  "engagement": {
    ...
    "description": "Una metodologia estructurada, desde la definicion inicial de la oportunidad hasta un sistema de workflow listo para produccion.",
    "steps": [
      {
        "number": "01",
  ...
  "leadForm": {
    ...
    "copy": "Hazlo breve. Usamos esto para entender el problema de workflow, equipo o producto que quieres conversar.",
    ...
    "privacyPrefix": "Al enviar este formulario, aceptas que Teambotics use tu informacion para responder a tu consulta. Consulta nuestra ",
  ...
  "productPage": {
    ...
    "detailDescription": "Cada producto de Teambotics se plantea como un sistema practico: valor claro para la persona usuaria, comportamiento de IA controlado y un camino desde el prototipo hasta la adopcion operativa.",
